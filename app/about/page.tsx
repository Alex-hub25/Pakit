    ...
    <div className={`${darkMode ? "dark" : ""}`}>
      <div className={`min-h-screen flex flex-col transition-colors ${darkMode ? "bg-white text-black" : "bg-black text-white"}`}>
        ...
        <main className="flex flex-1 flex-col items-center justify-center py-12 px-4 text-center">
          <h1 className="text-4xl font-bold mb-4 text-orange-500">About PAKIT</h1>
          <p className="max-w-2xl mb-8">
            PAKIT is dedicated to providing scalable, automated fulfillment solutions for businesses of all sizes.
            Our mission is to streamline your logistics, enhance your brand, and deliver exceptional customer experiences.
          </p>
